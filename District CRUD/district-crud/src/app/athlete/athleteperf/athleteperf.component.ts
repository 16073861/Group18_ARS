...
@Component({
  selector: 'app-athleteperf',
  templateUrl: './athleteperf.component.html',
  styleUrls: ['./athleteperf.component.css']
})
export class AthleteperfComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dataService.getAthletePerformance(this.CompetitionID)
